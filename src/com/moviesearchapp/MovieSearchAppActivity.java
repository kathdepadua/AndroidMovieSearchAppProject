...
import android.app.ProgressDialog; //ProgressDialog widget is used in order to let the user know that data retrieval takes place and that he should be patient
...
import com.moviesearchapp.services.PersonSeeker;
import com.moviesearchapp.services.GenericSeeker;
...
public class MovieSearchAppActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main); //setting view - main.xml
